...
W = tf.constant([[[[1., 10., -2]], [[1., 10., -2]]],
                 [[[1., 10., -2]], [[1., 10., -2]]]]) # (2, 2, 1, 3) (x, y, the number of colors, the number of filters)
...
for i, one_image in enumerate(conv2d_image):
    ...
    plt.subplot(1,3,i+1), plt.imshow(one_image.reshape(3,3), cmap='gray')
